...
## Next Up
- **Session 2 testing**: Verify #9a research rules appear in playbooks (blog/product/homepage). Verify #9b intent flow (content preview, improved suggestions, relevance score). Re-crawl pages to populate page_elements for projects that were crawled pre-v3.6.
